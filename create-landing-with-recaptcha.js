...
const RECAPTCHA_SITE_KEY = process.env.RECAPTCHA_SITE_KEY || 'REPLACE_WITH_SITE_KEY';
...
console.log('✅ Created public/signup.js');

fs.writeFileSync(path.join(assetsDir, 'main.css'), mainCss);
console.log('✅ Created public/assets/main.css');

console.log('🎉 Landing page files generated successfully! Place your logo in public/assets/athaanfi-logo.png');
